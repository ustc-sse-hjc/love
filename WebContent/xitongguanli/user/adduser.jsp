...
%>
<%
	List<jobInfo> list = (List<jobInfo>) request.getAttribute("addselectjob");
			
%>

 <%
	List<jigouInfovo> list1 = (List<jigouInfovo>) request.getAttribute("addgetjigou");
%>
...
<table border="1" width="35%" height="650">
	...
	<td colspan="2" style="border-style: dotted; border-width: 1px" align="center" bgcolor="#EBEBEB">修改用户信息</td>
		...
		<td width="40%" ><input type="text"  name="u_pwd"/></td>
	</tr>
	  <tr>
		<td width="24%"bgcolor="#EBEBEB">登陆账号：</td>
		<td width="40%"><input type="text"  name="u_login"/></td>
	</tr>
	  <tr>
		<td width="24%"bgcolor="#EBEBEB">姓名：</td>
	    <td width="40%"><input type="text"  name="u_name"/></td>
	</tr>
	  <tr>
...
<option value="1">1</option></select>  
	  ...
	  <tr>
		...
		<td width="40%"><input type="text"  name="u_number"/></td>
	</tr>
	<tr>
