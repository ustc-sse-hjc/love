...
<html>
  ...
  <body>
   <p><b><font color="#808080">统计分析&gt;&gt;统计结果&gt;&gt;全部开启方案</font></b> </p>
 
<table border="1" width="70%" id="table1">
 
	<tr>
	
		<td bgcolor="#EBEBEB"colspan="9">方案信息列表</td>
	</tr>
<tr>
...
<%
	...
	<tr> 
	 ...
	 %>
       ...
       <td><a href="asdf?ptype=<%=program.getPtype()%>&pname=<%=program.getPname()%>&pid=<%=program.getPid()%> " >选择</a></td> 
