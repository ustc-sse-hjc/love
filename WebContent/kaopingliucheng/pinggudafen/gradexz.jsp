...
<hr>
<p>方案名称：<%=pname%>&nbsp; 考评方式：投票打分&nbsp; 状态：开始打分&nbsp;&nbsp;&nbsp;  
...
<hr>
 ...
 cycleInfo v=ss.get(i);
  %>
  <a target="I5" href="programjigouAction"><%=v.getPs_name() %></a>
 <%} %>
<p>           
<p>
	 
		<iframe name="I5" src="programjigouAction" width="818" height="449" style="border-style: dotted; border-width: 1px">
