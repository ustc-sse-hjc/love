...
%>
	<%
			...
			String vname = request.getParameter("vote_name");
			String vtype= request.getParameter("vote_type");
		 
			int vptid = Integer.parseInt(request.getParameter("vote_ptid").trim());
    
	 %>
	
 <%
	List<programtypeInfo> list= (List<programtypeInfo>) request.getAttribute("gettype");
%> 
...
<% int vid = Integer.parseInt(request.getParameter("v_id").trim()); 
...
<table border="1" width="40%" id="table3" height="350">
	...
	<tr>
		...
		<td width="40%"><input type="text"  name="v_name" value=<%=vname%>></td>
	</tr>
	<tr>
