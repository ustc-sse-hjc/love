...
System.out.println("in menu"+path+"***"+basePath);
...
<li><div id="two1" onMouseOver="change(this)" onMouseOut="back_color(this)"><a target="I2" href="jobAction" >
	<font size="3" color="#FFFFFF">
	<span style="text-decoration: none; font-weight: 700">岗位管理</span></font></a></div></li>
	
<li><div id="two1" onMouseOver="change(this)" onMouseOut="back_color(this)"><a target="I2" href="roleAction" >
	<font size="3" color="#FFFFFF">
	<span style="text-decoration: none; font-weight: 700">角色管理</span></font></a></div></li>
</ul>
</li>
</ul>
...
<ul id="twoul2">
<li><div id="two1" onMouseOver="change(this)" onMouseOut="back_color(this)"><a target="I2" href="levelAction" >
	<font size="3" color="#FFFFFF">
	<span style="text-decoration: none; font-weight: 700">评估结果分布等级</span></font></a></div></li>
 
<li><div id="two1" onMouseOver="change(this)" onMouseOut="back_color(this)"><a target="I2" href="voteAction">
	<font size="3" color="#FFFFFF">
...
<ul id="threeul1">
<li><div id="two1" onMouseOver="change(this)" onMouseOut="back_color(this)"><a target='I2' href="programtypeAction" >
	<font size="3" color="#FFFFFF">
	<span style="text-decoration: none; font-weight: 700">考评方案设置</span></font></a></div></li>
<li><div id="two1" onMouseOver="change(this)" onMouseOut="back_color(this)"><a href="selectopenprogram" target='I2'>
	<font size="3" color="#FFFFFF">
	<span style="text-decoration: none; font-weight: 700">开始与结束评估</span></font></a></div></li>
 
<li><div id="two1" onMouseOver="change(this)" onMouseOut="back_color(this)"><a href='getallprogram' target='I2'>
	<font size="3" color="#FFFFFF">
...
<ul id="oneul2">
<li><div id="two1" onMouseOver="change(this)" onMouseOut="back_color(this)"><a href='qwer' target='I2'>
	<font size="3" color="#FFFFFF">
