...
<ul id="threeul1">
<li><div id="two1" onMouseOver="change(this)" onMouseOut="back_color(this)"><a href='programtypeAction' target='I2'>
	<font size="3" color="#FFFFFF">
	<span style="text-decoration: none; font-weight: 700">考评方案设置</span></font></a></div></li>
<li><div id="two1" onMouseOver="change(this)" onMouseOut="back_color(this)"><a href='考评流程/开始与结束评估/schemeStart.html' target='I2'>
	<font size="3" color="#FFFFFF">
	<span style="text-decoration: none; font-weight: 700">开始与结束评估</span></font></a></div></li>
 
<li><div id="two1" onMouseOver="change(this)" onMouseOut="back_color(this)"><a href='考评流程/评估打分/gradexz.html' target='I2'>
	<font size="3" color="#FFFFFF">
