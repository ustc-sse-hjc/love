...
<body>
	...
	<div class="cs">
		<img src="thumbs/31.jpg" id="logo"
			onclick="location='http://localhost:8080/LovePro/lovehome.jsp'">
	</div>

	<canvas class="canvas" width="1820" height="905"></canvas>
	<!-- <p class="text" style="font-size: 40px;">
		我们如此相爱，只愿 <br /> <span id="span_dt_dt">死生契阔，与子成说，执子之手，与子偕老</span>
	</p> -->
	<script>	
    var S = {
        init: function () {
			...
			//想说的话
            S.UI.simulate("秦梦螺|我爱你|你是我|不能失去|的|唯一|❤|你知道吗?|我们已经相爱|#time");
                ...
                switch (action) {
                    ...
                    case 'time':
                    	/* window.setTimeout("show_date_time()", 1000); */
       					BirthDay = new Date("2/26/2019 00:00:00");//这个日期是可以修改的
        				today = new Date();
        				...
        				var t = daysold + "天" + hrsold + "小时" + minsold + "分";
                        ...
                        if (sequence.length > 0) {
                            ...
                            timedAction(function () {
        						...
        						t = daysold + "天" + hrsold + "小时" + minsold + "分";
                            	S.Shape.switchShape(S.ShapeBuilder.letter(t));
                    ...
                    default:
                        S.Shape.switchShape(S.ShapeBuilder.letter(current[0] === cmd ? '嘻嘻' : current));
                }
